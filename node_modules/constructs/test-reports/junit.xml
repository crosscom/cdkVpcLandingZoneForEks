...
<testsuites name="jest tests" tests="44" failures="0" errors="0" time="4.462">
  <testsuite name="undefined" errors="0" failures="0" skipped="0" timestamp="2020-11-26T06:20:17" time="3.502" tests="43">
    ...
    <testcase classname=" construct id can use any character except the path separator" name=" construct id can use any character except the path separator" time="0.008">
    </testcase>
    ...
    <testcase classname=" construct.getChild(name) can be used to retrieve a child from a parent" name=" construct.getChild(name) can be used to retrieve a child from a parent" time="0">
    </testcase>
    ...
    <testcase classname=" node.addValidation() can be implemented to perform validation, node.validate() will return errors" name=" node.addValidation() can be implemented to perform validation, node.validate() will return errors" time="0">
    </testcase>
  ...
  <testsuite name="undefined" errors="0" failures="0" skipped="0" timestamp="2020-11-26T06:20:21" time="0.162" tests="1">
    <testcase classname=" Aspects are invoked only once" name=" Aspects are invoked only once" time="0.001">
    </testcase>
  </testsuite>
</testsuites>